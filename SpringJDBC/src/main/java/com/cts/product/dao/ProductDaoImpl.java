...
public class ProductDaoImpl {
	 ...
	 * DRL
	 * 
	 * 1. ResultsetExtractor 2.RowCallbackHandler 3. RowMapper
	 */
	...
	public List<Product> findByName(String productName) {
		List<Product> prods = jt.query("select * from product where product_name like ?",
...
//display product By id
	...
	public List<Product> findRange(double price1, double price2) {
		...
		List<Product> prods = jt.query("select * from product where price between ? and ?",
				new ResultSetExtractorDemoByRange(), price1, price2);
	...
	public List<Product> findProductNumbers(int prod1, int prod2) {
		...
		List<Product> prods = jt.query("select distinct * from product where product_id between ? and ?",
				new ResultSetExtractorDemoByProductNumber(), prod1, prod2);
